...
Class ConSeleccionador extends CI_Controller{
  ...
  public function createPDF(){
    ...
    if($proceso == 'Previo'){
    	$data['dataInfAcuse_prev'] = $this->ModSeleccionarDatos->ConsultaConstTablaAcuseRecibo($codigo,$proceso);
    	$data['tablaConteoDelitos_prev'] = $this->ModSeleccionarDatos->ConsultaDelitosConstTablaAcuseReciboPrev($codigo);
   	  $this->load->view("viewAcuseEnvioPDFPrevio", $data);
    }
	...
	public function CargaVistaReporteCargas(){

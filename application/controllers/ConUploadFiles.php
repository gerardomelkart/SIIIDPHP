...
Class ConUploadFiles extends CI_Controller{
    ...
    private function read_csv($path, $codigoRef, $proceso, $anioCorte, $mesCorte) {
	    ...
	    $fecha = new DateTime('first day of this month');  // Forzamos día 1 para evitar errores de calendario
	            	...
	            	date_default_timezone_set('UTC');
		              ...
		              $data[] = array_merge(
		                ...
		                [
		                    ...
		                    'fcha_insert' => gmdate('Y-m-d H:i:s', time() - 6*3600),
    ...
    public function insert_tmp($codigoRef,$proceso,$anioCorte,$mesCorte) {
        ...
        $headers3['usuario_reg'] = 'usuario_reg'; //agregar la columna 'usuario_reg' a la tabla de victimas
        $headers3['fcha_insert'] = 'fcha_insert'; //agregar la columna 'fcha_insert' a la tabla de victimas
        $headers3['codigo_referencia'] = 'codigo_referencia'; //agregar la columna 'codigo_referencia' a la tabla de victimas
        $headers3['mes_corte'] = 'mes_corte'; //agregar la columna 'mes_corte' a la tabla de victimas
        $headers3['anio_corte'] = 'anio_corte'; //agregar la columna 'anio_corte' a la tabla de victimas
        ...
        if ($this->db->trans_status() === FALSE) {
            show_error('Error en la inserción');
	        	...
	        	$cod_ref = $obtDatosValIntegridad[0]->codigo_referencia;
	        	$tot_menosVICvsDEL = $obtDatosValIntegridad[0]->menosVICvsDEL;
	        	$tot_Reg_Carp_noExist_delit = $obtDatosValIntegridad[0]->total_Reg_Carp_noExist_delit;
	        	$tot_Reg_Carp_noExist_vict = $obtDatosValIntegridad[0]->total_Reg_Carp_noExist_vict;
	        	$tot_Reg_Delit_noExist_carp = $obtDatosValIntegridad[0]->total_Reg_Delit_noExist_carp;
	        	$tot_Reg_Delit_noExist_vict = $obtDatosValIntegridad[0]->total_Reg_Delit_noExist_vict;
	        	$tot_Reg_vict_noExist_carp = $obtDatosValIntegridad[0]->total_Reg_vict_noExist_carp;
	        	$tot_Reg_vict_noExist_delit = $obtDatosValIntegridad[0]->total_Reg_vict_noExist_delit;
	        	$estatus_rval_integ_ref = $obtDatosValIntegridad[0]->estatus_rval_integridad_referencial;
						...
						<body>
							...
							<div class='contenedor'>
								...
								<div class='card mt-5' style='border:none; background-color: #fff;'>
									...
									<div class='txtareaMsj' contenteditable='false' 
									              style='display: inline-block; 
								                      padding: 6px 7px;
								                      color: #9F2241; 
								                      text-decoration: none; 
								                     '> Se identificaron inconsistencias en la integridad referencial entre los archivos. Cada carpeta debe tener al menos un delito asociado, y este a su vez, al menos una víctima asociada al delito. Favor de verificar, corregir y enviar nuevamente su información.
									</div>

									<table class='tblIntegridadReferencial'>
									  <thead>
									  ...
									  <tbody>";
									  		...
									  		if($tot_menosVICvsDEL > 0){
										    	$inconsistencia = 'tot_menosVICvsDEL';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros con referencia incorrecta entre delitos y victimas:
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_menosVICvsDEL</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros con referencia incorrecta entre delitos y victimas:</td>
											      <td style='text-align: center;'>$tot_menosVICvsDEL</td>
											    </tr>
											    ";
										   }

										   if($tot_Reg_Carp_noExist_delit > 0){
										    	$inconsistencia = 'tot_Reg_Carp_noExist_delit';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de carpetas que no existen en delitos de acuerdo al \"ID_CI\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_Carp_noExist_delit</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de carpetas que no existen en delitos de acuerdo al \"ID_CI\":</td>
											      <td style='text-align: center;'>$tot_Reg_Carp_noExist_delit</td>
											    </tr>
											    ";
										   }

										   if($tot_Reg_Carp_noExist_vict > 0){
										    	$inconsistencia = 'tot_Reg_Carp_noExist_vict';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de carpetas que no existen en víctimas de acuerdo al \"ID_CI\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_Carp_noExist_vict</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de carpetas que no existen en víctimas de acuerdo al \"ID_CI\":</td>
											      <td style='text-align: center;'>$tot_Reg_Carp_noExist_vict</td>
											    </tr>
											    ";
										   }

										   if($tot_Reg_Delit_noExist_carp > 0){
										    	$inconsistencia = 'tot_Reg_Delit_noExist_carp';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de delitos que no existen en carpetas de acuerdo al \"ID_CI\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_Delit_noExist_carp</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de delitos que no existen en carpetas de acuerdo al \"ID_CI\":</td>
											      <td style='text-align: center;'>$tot_Reg_Delit_noExist_carp</td>
											    </tr>
											    ";
										   }

										   if($tot_Reg_Delit_noExist_vict > 0){
										    	$inconsistencia = 'tot_Reg_Delit_noExist_vict';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de delitos que no existen en víctimas de acuerdo al \"ID_CI\" y \"ID_DELITO\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_Delit_noExist_vict</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de delitos que no existen en víctimas de acuerdo al \"ID_CI\" y \"ID_DELITO\":</td>
											      <td style='text-align: center;'>$tot_Reg_Delit_noExist_vict</td>
											    </tr>
											    ";
										   }


										   if($tot_Reg_vict_noExist_carp > 0){
										    	$inconsistencia = 'tot_Reg_vict_noExist_carp';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de víctimas que no existen en carpetas de acuerdo al \"ID_CI\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_vict_noExist_carp</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de víctimas que no existen en carpetas de acuerdo al \"ID_CI\":</td>
											      <td style='text-align: center;'>$tot_Reg_vict_noExist_carp</td>
											    </tr>
											    ";
										   }

										   if($tot_Reg_vict_noExist_delit > 0){
										    	$inconsistencia = 'tot_Reg_vict_noExist_delit';
										    	echo"
											    <tr>
											      <td style='text-align: center;'>
											            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
											               style='display: inline-block; 
											                      ...
											                      text-decoration: none; 
											                     '>
											                Total de registros de víctimas que no existen en delitos de acuerdo al \"ID_CI\" y \"ID_DELITO\":
											            </a>
											        </td>
											      <td style='text-align: center; Color: #9F2241;'>$tot_Reg_vict_noExist_delit</td>
											    </tr>
											    ";
										   }else{
										   		echo"
											    <tr>
											      <td>Total de registros de víctimas que no existen en delitos de acuerdo al \"ID_CI\" y \"ID_DELITO\":</td>
											      <td style='text-align: center;'>$tot_Reg_vict_noExist_delit</td>
											    </tr>
											    ";
										   }
...
//$mesCorte = $this->session->mes_corte;
	        	...
	        	$fecha_ini_NoCoincide_con_Periodo_actualizacion = $obtDatos[0]->fcha_ini_NoCoincide_con_Periodo_act;
	        //	$cve_tipoExp_incorrecta = $obtDatos[0]->cve_texp_incorrecta;  /** de elimino el campo ID_TEXP**/
	        ...
	        /*	$tot_dto_prin_incorrecto = $obtDatosDel[0]->total_dto_prin_incorrecto; ** se elimino el campo  DTO_PRIN */
	        ...
	        /*	$Exp_con_masdeuno_o_sin_dtoPrin = $obtDatosDel[0]->Exp_conmasdeuno_o_sin_dtoPrin; ** se elimino el campo DTO_PRIN  **/
	       ...
	       /** 	$tot_id_tv_null = $obtDatosVict[0]->total_id_tv_null;   SE ELIMINO  **/
	        	...
	        	$dts_incorrectos_si_es_PM = $obtDatosVict[0]->datos_incorrectos_si_es_personaMoral;
	        ...
	        /*	$clave_rel_vict_imputado_incorrecto = $obtDatosVict[0]->cve_rel_vict_imputado_incorrecto; ** se elimino el campo */
					...
					<div class='contenedor'>
						...
						<div class='card mt-5' style='border:none; background-color: #fff;'>
							...
							if ($proceso == 'Actualizaciones'){    
							   ...
							   if($fecha_ini_NoCoincide_con_Periodo_actualizacion  > 0){
							    	$inconsistencia = 'fecha_ini_NoCoincide_con_Periodo_actualizacion ';
							   		echo"
							   		<tr>
								      <td style='text-align: center;'>
							            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
							               style='display: inline-block; 
							                      ...
							                      text-decoration: none; 
							                     '>
							               Fecha de inicio de la carpeta no coincide con el periodo que requiere actualizar:
							            </a>
								      </td>
								      <td style='text-align: center; Color: #9F2241;'>$fecha_ini_NoCoincide_con_Periodo_actualizacion</td>
								    </tr>
							   		";
							   }else{
							   		echo"
							   		<tr>
								      <td>Fecha de inicio de la carpeta no coincide con el periodo que requiere actualizar:</td>
								      <td style='text-align: center;'>$fecha_ini_NoCoincide_con_Periodo_actualizacion</td>
								    </tr>
							   		";
							   } 
							 }  
							...
							<table class='tblCarpetas'>
							  ...
							  <tbody>
							    ...
							    if($tot_id_delito_duplicados > 0){
								      ...
								      <td style='text-align: center;'>
								            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
								               style='display: inline-block; 
								                      ...
								                      text-decoration: none; 
								                     '>
								             Registros duplicados según los campos \"ID_CI\", \"ID_DELITO\", \"MODA_DTO\", \"FORMA_ACC\", \"GRDO_CONS\", \"CLASF_DE_DTO\":
								            </a>
								        </td>
							    	...
							    	echo"
								    <tr>
								      <td>Registros duplicados según los campos \"ID_CI\", \"ID_DELITO\", \"MODA_DTO\", \"FORMA_ACC\", \"GRDO_CONS\", \"CLASF_DE_DTO\":</td>
							...
							// 	    </tr>
							   ...
							   if($long_hraHchos_incorrecta > 0){
								      ...
								      <td style='text-align: center; Color: #9F2241;'>$long_hraHchos_incorrecta</td>
							   		...
							   		echo"
							   		<tr>
								      <td>Hora de hechos con formato incorrecto:</td>
...
<!-- TABLA VICTIMAS  -->
							...
							<table class='tblCarpetas'>
							  ...
							  <tbody>
							   ...
							   if($dts_incorrectos_si_es_PM  > 0){
							   		$inconsistencia = 'dts_incorrectos_si_es_PM ';
							   		echo"
									    <tr>
									        <td style='text-align: center;'>
									            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
									               style='display: inline-block; 
									                      ...
									                      text-decoration: none; 
									                     '>
									                Persona Moral con datos de Persona Física registrados:
									            </a>
									        </td>
									        <td style='text-align: center; Color: #9F2241;'>$dts_incorrectos_si_es_PM </td>
									    </tr>";
							   }else{
							   		echo"
							   		<tr>
								      <td>Persona Moral con datos de Persona Física registrados:</td>
								      <td style='text-align: center;'>$dts_incorrectos_si_es_PM </td>
								    </tr>
							   		";
							   }
							   ...
							   if($tot_pob_null > 0){
								      ...
								      <td style='text-align: center;'>
								            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
								               style='display: inline-block; 
								                      ...
								                      text-decoration: none; 
								                     '>
								                La clave de pertenencia a población indígena no válida según el catálogo:
								      ...
								      <td style='text-align: center; Color: #9F2241;'>$tot_pob_null</td>
							   		...
							   		echo"
							   		<tr>
								      <td>La clave de pertenencia a población indígena no válida según el catálogo:</td>
							   ...
							   if($tot_disc_incorrecto > 0){
								      ...
								      <td style='text-align: center;'>
								            <a href='../../ConExportar/generar_csv/$cod_ref/$inconsistencia' 
								               style='display: inline-block; 
								                      ...
								                      text-decoration: none; 
								                     '>
								                La clave de presencia de discapacidad en la víctima no válida según el catálogo:
								            </a>
								        </td>
								      <td style='text-align: center; Color: #9F2241;'>$tot_disc_incorrecto</td>
							   		...
							   		echo"
							   		<tr>
								      <td>La clave de presencia de discapacidad en la víctima no válida según el catálogo:</td>
							   ...
							   if($format_fcha_nac_incorrecto > 0){
								     ...
								     <td style='text-align: center;'>
								      ...
								      <td style='text-align: center; Color: #9F2241;'>$format_fcha_nac_incorrecto</td>
							   		...
							   		echo"
							   		<tr>
								      <td>Fecha de nacimiento con formato incorrecto:</td>
	                    ...
	                    if (in_array($col_name, $columnas_fecha)) {
	                        if (!empty($value)) {
	                            if (is_numeric($value)) {
	                                ...
	                                $value = $dateTime ? $dateTime->format('Y-m-d') : $value;
	                            } else {
	                    	...
	                    	log_message('debug', "[$col_name] Valor recibido: " . print_r($value, true));
						    if ($value === '' || $value === null) {
						        $value = '';
						    } elseif (is_numeric($value) && $value < 1) {
						        // Hora como número decimal de Excel
						        $dateTime = \PhpOffice\PhpSpreadsheet\Shared\Date::excelToDateTimeObject($value);
						        $value = $dateTime ? $dateTime->format('H:i:s') : $value;

					...
					<div class="table-container">
						<table id="tablaRptCargas" class="table display nowrap table-hover table-bordered" >
							...
							<tbody>
							  ...
							  <?php
								foreach ($tablaRptCargas as $dato){
							 ?>  
								<tr style="font-size: 11px;">
									<td><?php echo $dato->nombre; ?></td>
									<td><?php echo $dato->mes_corte; ?></td>
									<td><?php echo $dato->intentos; ?></td>
									<td><?php echo $dato->ultimo_intento; ?></td>
									<td><?php echo $dato->cargas; ?></td>
									<td><?php echo $dato->ultima_carga; ?></td>
								</tr>
							  <?php } ?>  

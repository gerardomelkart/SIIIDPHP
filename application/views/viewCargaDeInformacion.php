	...
	<div class='contenedor'>
	  ...
	  <div class="col-md-8">	
		...
		<div class="card mt-3" style="border:none; background-color: #fff; ">
			...
			<p class="card-header text-white font-weight-bold text-left" id="titulo" style="background: #98989A; font-size: 20px;"><i class="fa fa-upload"></i> Carga de información, incidencia delictiva  </p>

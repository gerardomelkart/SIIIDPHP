...
<body>
    ...
    <div>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <tr>
                <td style=" text-align:right;  width:720px;">
                    ...
                    Ciudad de México a <?php echo $dataInfAcuse[0]->fecha_de_envio; ?></span>
                </td>
            </tr> 
        </table>
        ...
        <table>
            <tr>
                <td style=" text-align:center;  width:720px;" >
                    <br><br>
                    <span class="texto-sin-espacios" style="font-size: 20px;"><b>ACUSE DE ENTREGA DE INFORMACIÓN</b></span><br>
                </td>
            </tr> 
        </table>
        ...
        <div class="card mt-5">
                <p class="card-header text-white font-weight-bold text-left" id="titulo">Detalle de registros enviados:</p>
                <table class="tblResumenEnvioReg">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse[0]->TotReg_carpetas; ?></td>
                    </tr>
                    <tr>
                      <td class="tdDesc" style="padding-left:30px;">Delitos:</td>
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse[0]->TotReg_delitos; ?></td>
                    </tr>
                    <tr>
                      <td class="tdDesc" style="padding-left:30px;">Victimas:</td>
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse[0]->TotReg_victimas; ?></td>
                    </tr> 
                  </tbody>
                </table>
        </div>
                    ...
                    <?php
                        foreach ($tablaConteoDelitos as $dato){
                          ...
                          <tr style="font-size: 11px;">
                            <td><?php echo $dato->clave2_s; ?></td>
                            <td><?php echo $dato->delito_sabana; ?></td>
                            <td><?php echo $dato->clave3_s; ?></td>
                            <td><?php echo $dato->subtipo_delito_sabana; ?></td>
          ...
          <table class="" border="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="" style="text-align: center; width:84px; "><?php echo $dataInfAcuse[0]->TotReg_delitos; ?></td>
                  <td class="" style="text-align: center; width:91px; "><?php echo $dataInfAcuse[0]->TotReg_victimas; ?></td>
                </tr>
              </tbody>
         </table>

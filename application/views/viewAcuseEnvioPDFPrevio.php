    ...
    <div>
        ...
        <table>
            <tr>
                <td style=" text-align:center;  width:720px;" >
                    <br><br>
                    <span class="texto-sin-espacios" style="font-size: 20px;"><b>ACUSE PREVIO</b></span><br>
                </td>
            </tr> 
        </table>
        ...
        <div class="card mt-5">
                ...
                <table class="tblResumenEnvioReg">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse_prev[0]->TotReg_carpetas; ?></td>
                    </tr>
                    <tr>
                      <td class="tdDesc" style="padding-left:30px;">Delitos:</td>
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse_prev[0]->TotReg_delitos; ?></td>
                    </tr>
                    <tr>
                      <td class="tdDesc" style="padding-left:30px;">Victimas:</td>
                      <td class="tdDesc" style="text-align: center;"><?php echo $dataInfAcuse_prev[0]->TotReg_victimas; ?></td>
                    </tr> 
                  </tbody>
                </table>
        </div>
            ...
            <table id="tblResumenDelitos" border="1"  class="tblResumenDelitos" style="width:100%">
              ...
              <tbody>
                    <?php
                        foreach ($tablaConteoDelitos_prev as $dato){
          ...
          <table class="" border="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="" style="text-align: center; width:84px; "><?php echo $dataInfAcuse_prev[0]->TotReg_delitos; ?></td>
                  <td class="" style="text-align: center; width:91px; "><?php echo $dataInfAcuse_prev[0]->TotReg_victimas; ?></td>
                </tr>
              </tbody>
         </table>

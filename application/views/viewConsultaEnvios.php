							...
							<tr style="font-size: 11px;">
								...
								<td>
									<button type="button" class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="top" 
									    title="Consultar y descargar Acuse"
										onclick="verAcuse('<?php echo $dato->codigo_referencia; ?>')"><i class="fa fa-file-pdf" aria-hidden="true"></i></button>


									<a href='../../ConExportar/generar_csv_ExpedientesEnviados/<?php echo $dato->codigo_referencia; ?>' 
									class="btn btn-outline-success btn-sm" title="Descargar Registros Enviados">
